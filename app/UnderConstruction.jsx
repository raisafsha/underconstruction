  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-yellow-300 flex items-center justify-center text-center p-6">
      ...
      >
        ...
        <p className="text-lg text-gray-700 mb-6">We're working hard! Coming back online on:</p>
        <div className="flex justify-center gap-4 text-xl font-semibold text-gray-800">
